...
```
kav@ubuntu:~/netology/sysadm-homeworks$ ./3script_py.sh
/home/kav/netology/sysadm-homeworks/01-intro-01/netology.jsonnet
/home/kav/netology/sysadm-homeworks/04-script-01-bash/README.md
/home/kav/netology/sysadm-homeworks/04-script-02-py/README.md
...
### Вывод скрипта при запуске при тестировании:
```
kav@ubuntu:~$ ./4script.sh
Введите полный путь к репозиторию(со знаком '/' в конце):
/home/kav/new_repo/netology/ <--- пишем путь к репо
    
/home/kav/new_repo/netology/README.md
/home/kav/new_repo/netology/netology.tf
/home/kav/new_repo/netology/netology.yaml
```
...
### Вывод скрипта при запуске при тестировании:
```
C:\PycharmProjects\py\scripts\python.exe C:/PycharmProjects/py/123.py
